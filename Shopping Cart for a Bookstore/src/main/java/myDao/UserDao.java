...
public class UserDao {
	...
	public void addUser(User user) throws SQLException {
		...
		Object[] params = { user.getName(), user.getPassword(), user.getTel(), user.getEmail() };
	...
	/*
	 * public List findOtherBookByTag(String tag1,String tag2,String tag3,String
	 * tag4,String tag5,String tag6) throws SQLException{ QueryRunner qr=new
	 * QueryRunner(JdbcUtils.getDataSource()); String
	 * sql="select * from book where tag != ?and tag !=?and tag!="; Object[]
	 * params={tag1,tag2,tag3,tag4,tag5,tag6}; List<Book> books=qr.query(sql,new
	 * BeanListHandler<Book>(Book.class),params); return books; }
	 */
}